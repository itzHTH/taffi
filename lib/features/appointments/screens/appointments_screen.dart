...
class _AppointmentScreenState
  ...
  Future<void> _showCancelConfirmationDialog(
    ...
    final result = await ConfirmationDialog.show(
      ...
      doctorName:
          appointments[index]['doctorName'] as String,
      appointmentDate:
          appointments[index]['appointmentDate'] as String,
      appointmentTime:
          appointments[index]['appointmentTime'] as String,
    );
      ...
      SnackBar(
        content: Row(
          children: [
            ...
            Expanded(
              child: Text(
                'تم إلغاء الموعد مع $canceledDoctor بنجاح',
